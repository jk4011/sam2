...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        return self.init_state_from_tensors(images, video_height, video_width, offload_video_to_cpu, offload_state_to_cpu)
    

    @torch.inference_mode()
    def init_state_from_tensors(self, images, video_height, video_width, offload_video_to_cpu=False, offload_state_to_cpu=False):
